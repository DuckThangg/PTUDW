                ...
                <div class="form">
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $sql_update_phieu = "UPDATE phieu_dang_ky SET ten_hoc_sinh='$ten_update', ngay_sinh_hs = '$ngay_sinh_update', gioi_tinh_hs='$gioi_tinh_update', nam_hoc='$nam_hoc_update' WHERE id_phieu='$id_hoc_sinh'";
                            $sql_update_gh = "UPDATE giam_ho SET ten_hoc_sinh='$ten_update' WHERE id_hoc_sinh='$id_hoc_sinh'";

                            $result_update = $conn->query($sql_update);
                            $result_update_phieu = $conn->query($sql_update_phieu);
                            $result_update_gh = $conn->query($sql_update_gh);

                            if ($result_update === TRUE || $result_update_phieu === TRUE ||$result_update_gh === TRUE){
