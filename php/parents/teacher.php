...
<head>
    ...
    <style>
        ...
        /* Định dạng dòng lẻ */
        .odd-row {
            background-color: #a8e6cf; /* Màu nền xanh lục */
        }
    </style>
</head>
<body>
                ...
                if($user_role == 'Giáo viên'){
                    echo "
                        <div>
                            ...
                            <li><a href='/PHP/BTL/php/teacherparents.php'>Phụ huynh</a></li>
    ...
    <?php
        ...
        if (isset($_SESSION['user_name'])){
            ...
            if ($result && $result->num_rows > 0) {
                ...
                if ($position === 'ADMIN') {
                    echo "<button style='margin:50px 50px 0 400px;'><a href='/PHP/BTL/php/admin/add_teacher.php'>Thêm giáo viên</a></button>";
